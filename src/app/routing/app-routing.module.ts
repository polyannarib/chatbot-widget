...
const APP_ROUTES: Routes = [
  ...
  { path: 'management', loadChildren: '../modules/management/management.module#ManagementModule', canLoad:[AuthGuard], canActivate:[AuthGuard], data: { scopes: ['wpplayer', 'wpleader', 'wpboss', 'wprule', 'wpmaster'] } },
